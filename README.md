...
| [`run_traffic_analysis.py`](./examples/run_traffic_analysis.py) | [`Traffic Analysis`](https://github.com/roboflow/supervision/tree/develop/examples/traffic_analysis) | `Track Vehicle Routes` | Tracks vehicles from configured entry zones to exit zones and displays unique origin-to-destination totals. |
